...
func TestL2Sequencer_SequencerDrift(gt *testing.T) {
	...
	for sequencer.SyncStatus().UnsafeL2.Time+sd.RollupCfg.SecondBlockInterval(12*1000) < origin.Time {
	...
	for sequencer.SyncStatus().UnsafeL2.Time+sd.RollupCfg.SecondBlockInterval(12*1000) <= origin.Time+sd.ChainSpec.MaxSequencerDrift(origin.Time) {
